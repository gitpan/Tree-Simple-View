# This Makefile is for the Tree::Simple::View extension to perl.
#
...
#     NAME => q[Tree::Simple::View]
#     PREREQ_PM => { Test::More=>q[0.47], Tree::Simple=>q[1.05] }
#     VERSION_FROM => q[lib/Tree/Simple/View.pm]
...
FULLEXT = Tree/Simple/View
BASEEXT = View
PARENT_NAME = Tree::Simple
DLBASE = $(BASEEXT)
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/Tree/Simple/View.pm \
	lib/Tree/Simple/View/Base.pm \
	lib/Tree/Simple/View/DHTML.pm \
	lib/Tree/Simple/View/HTML.pm
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Tree/Simple
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Tree/Simple
...
TO_INST_PM = lib/Tree/Simple/View.pm \
	lib/Tree/Simple/View/Base.pm \
	lib/Tree/Simple/View/DHTML.pm \
	lib/Tree/Simple/View/HTML.pm

PM_TO_BLIB = lib/Tree/Simple/View.pm \
	...
	lib/Tree/Simple/View/Base.pm \
	blib/lib/Tree/Simple/View/Base.pm
...
manifypods : pure_all lib/Tree/Simple/View.pm \
	lib/Tree/Simple/View/HTML.pm \
	lib/Tree/Simple/View/DHTML.pm \
	lib/Tree/Simple/View/Base.pm
	@$(POD2MAN) \
	lib/Tree/Simple/View.pm \
	$(INST_MAN3DIR)/Tree::Simple::View.$(MAN3EXT) \
	lib/Tree/Simple/View/HTML.pm \
	$(INST_MAN3DIR)/Tree::Simple::View::HTML.$(MAN3EXT) \
	lib/Tree/Simple/View/DHTML.pm \
	$(INST_MAN3DIR)/Tree::Simple::View::DHTML.$(MAN3EXT) \
	lib/Tree/Simple/View/Base.pm \
	$(INST_MAN3DIR)/Tree::Simple::View::Base.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Tree/Simple/View.pm blib/lib/Tree/Simple/View/HTML.pm
	rm -f blib/lib/Tree/Simple/View/DHTML.pm blib/lib/Tree/Simple/View/Base.pm
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/Tree/Simple/View.pm blib/lib/Tree/Simple/View.pm lib/Tree/Simple/View/HTML.pm blib/lib/Tree/Simple/View/HTML.pm lib/Tree/Simple/View/DHTML.pm blib/lib/Tree/Simple/View/DHTML.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{lib/Tree/Simple/View/Base.pm blib/lib/Tree/Simple/View/Base.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
